...
class RequestField:
    ...
    def __init__(
        ...
        header_formatter: typing.Callable[[str, typing.Union[str, bytes]], str] | None = None,
    ):
        self._name = name
    ...
    def _render_parts(
        self,
        header_parts: (
            dict[str, typing.Union[str, bytes] | None]
            | typing.Sequence[tuple[str, typing.Union[str, bytes] | None]]
        ),
    ) -> str:
        """
